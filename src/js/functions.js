...
let cambiarMenu = function(){
    if(body.className.includes("night--style")){
        if(burgerMenu.className.includes("open")){
            burgerMenu.src = "./../img/icons/header/close-modo-noct.svg";
        }else{
            burgerMenu.src = "./../img/icons/header/burger-modo-noct.svg";
        }
    }else{
        if(burgerMenu.className.includes("open")){
            burgerMenu.src = "./../img/icons/header/close.svg";
        }else{
            burgerMenu.src = "./../img/icons/header/burger.svg";
        }
    }
}
    ...
    if(gifArrayObjetos.length !== 0){
        for(let i = 0; i < limit; i++){
            ...
            if(gifObject !== undefined){
                ...
                favIcon.src = "./../img/icons/home-main/hoverIcons/icon-fav.svg";
                downloadIcon.src = "./../img/icons/home-main/hoverIcons/icon-download.svg";
                expandIcon.src = "./../img/icons/home-main/hoverIcons/icon-max-normal.svg";
                removeIcon.src = "./../img/icons/home-main/hoverIcons/icon-trash-normal.svg";
                ...
                const favIconSettings = function(icon){
                    ...
                    hover(icon,"./../img/icons/home-main/hoverIcons/icon-fav-hover.svg",
                    "./../img/icons/home-main/hoverIcons/icon-fav.svg", "./../img/icons/home-main/hoverIcons/icon-fav-active.svg");

                    Nighthover(icon,
                        "./../img/icons/home-main/hoverIcons/icon-fav-hover.svg",
                        "./../img/icons/home-main/hoverIcons/icon-fav.svg", "./../img/icons/home-main/hoverIcons/icon-fav-active.svg"); 

                    activeClass(icon, 
                        "./../img/icons/home-main/hoverIcons/icon-fav-active.svg", 
                        "./../img/icons/home-main/hoverIcons/icon-fav-hover.svg",
                        "./../img/icons/home-main/hoverIcons/icon-fav.svg",
                        "./../img/icons/home-main/hoverIcons/icon-fav-hover.svg");
                ...
                const expandSettings = function(icon){
                    hover(icon,
                        "./../img/icons/home-main/hoverIcons/icon-max-hover.svg",
                        "./../img/icons/home-main/hoverIcons/icon-max-normal.svg");
                ...
                const removeSettings = function(icon){
                    hover(icon,
                        "./../img/icons/home-main/hoverIcons/icon-trash-hover.svg",
                        "./../img/icons/home-main/hoverIcons/icon-trash-normal.svg");
